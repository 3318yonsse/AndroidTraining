        ...
        public void onClick(View v) {
            ...
            switch (v.getId()){
                ...
                case R.id.btn_update :
                    ...
                    Toast.makeText(MainActivity.this, "검색 후 선택을 짧게 하시면 수정화면으로 이동 합니다.", Toast.LENGTH_SHORT).show();
                    break;
                case R.id.btn_delete :

                    Toast.makeText(MainActivity.this, "검색 후 선택을 길게 하시면 삭제화면으로 이동 합니다.", Toast.LENGTH_SHORT).show();
                    break;
