package com.androidlec.selectdialog4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.callButton).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                LinearLayout linear = (LinearLayout) View.inflate(MainActivity.this,R.layout.order, null);
                new AlertDialog.Builder(MainActivity.this)
                        ...
                        .setPositiveButton("확인", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                // linear에 있는 product Edittext를 불러
                                ...
                                text.setText("주문정보 : " + product.getText() + " 상품, " + number.getText() + "개." +
